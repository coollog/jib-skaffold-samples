...
kubectl run helloworld-sub --image=gcr.io/qingyangc-sandbox/skaffold-sub-jib --port=5005 -o yaml --dry-run > temp1
kubectl run helloworld-sub --image=gcr.io/qingyangc-sandbox/skaffold-sub-jib --port=4567 -o yaml --dry-run > temp2
